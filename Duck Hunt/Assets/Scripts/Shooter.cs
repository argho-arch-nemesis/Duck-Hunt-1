...
//			scoreTxt.text = score.ToString().PadLeft(6, '0');
    ...
    public void shoot(Vector3 pos)
    {
        ...
        if (bulletAmount == 0)
        {
            ...
            Debug.DrawRay(Camera.main.ScreenToWorldPoint(pos), Camera.main.transform.forward, Color.red, 3f);

            if (Physics.Raycast(Camera.main.ScreenToWorldPoint(pos), Camera.main.transform.forward, out hit,
                    Mathf.Infinity))
            {
                if (hit.transform.tag == "Duck")
                {
        ...
        else
        {
            ...
            Debug.DrawRay(pos, Camera.main.transform.forward, Color.red, 3f);
